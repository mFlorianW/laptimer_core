...
MainScreen::MainScreen(Rapid::Positioning::IGpsInformationProvider& gpsInfoProvider)
    : Screen{}
    ...
    , mStatusBarModel{gpsInfoProvider}
{
    ...
    lv_line_set_points(m_separator_line,
                       mSeparatorPoints, // NOLINT(cppcoreguidelines-pro-bounds-array-to-pointer-decay)
                       2);
